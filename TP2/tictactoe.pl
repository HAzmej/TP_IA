...
ligne(L, M) :- nth1(_X,M,L).
 
colonne(C,M) :- nth1(X,M,_P),findall(P, (ligne(L, M),nth1(X,L,P)),C).
...
heuristique(J,Situation,H) :-  
	adversaire(J,Opponent),
    findall(D,(alignement(D,Situation),possible(D,J)),ListPlayer),
